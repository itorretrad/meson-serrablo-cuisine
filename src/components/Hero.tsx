  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src={heroImage}
          alt="Interior elegante del restaurante Mesón Serrablo"
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl mb-8 text-white/80 max-w-2xl mx-auto leading-relaxed">
          Descubre los sabores auténticos de Aragón en un ambiente cálido y acogedor. 
          Especialidades en jamón ibérico de bellota, cordero lechal y los mejores vinos de la región.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            size="lg"
            className="bg-primary hover:bg-primary-dark text-primary-foreground font-medium px-8 py-3 rounded-lg shadow-medium hover:shadow-strong transition-all duration-300 transform hover:scale-105"
          >
            Ver Carta
          </Button>
          <Button 
